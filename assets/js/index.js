    ...
    cardThree.innerHTML += `<div class="col  d-flex justify-content-center align-items-center">
                                <div class="card smallCards p-2">
                                    ...
                                    <div class="card-body text-dark w-100 word-wrap">
                                        ...
                                        <a href="artist_page.html?artistId=${musicList3[i].artist.id}&artist=${musicList3[i].artist.name}"><p class="opacity-50 sizeTesto2 text-light ">${musicList3[i].artist.name}</p></a>
                                    </div>
